    ...
    <div class="container">
        ...
        <?php
          if(isset($_POST['submit']))
          {
            ...
            ?>
            <div class="row">
            <div class="col-xs-12 col-md-4 onglet_eleve2 text-center"><h3><?php echo " ".$rep2['prenom']." ".$rep2['nom']; ?></h3></div>
            <div class="col-xs-12 col-md-4 onglet_eleve1 text-center"><h3>
              <?php
